  ...
  return (
    <div style={{ ...S.app, alignItems: "center", justifyContent: "center" }}>
      ...
      <div style={{ maxWidth: 380, width: "100%", padding: 32 }}>
        ...
        <h1 style={{ ...S.h1, fontSize: 24, marginTop: 16 }}>
        ...
        <button
          style={{ background: "none", border: "none", color: C.inkSoft, fontSize: 12.5, marginTop: 14, cursor: "pointer", textDecoration: "underline" }}
...
function Sidebar({ active, setActive, profile, onLogout }) {
  const items = [
    ...
    { key: "gestao", label: "Ferramenta de Gestão", icon: BarChart2 },
  ];
  return (
        ...
        {items.map((it) => {
          ...
          return (
            <button key={it.key} onClick={() => setActive(it.key)}
              style={{ ...S.navItem, background: isActive ? C.ink : "transparent", color: isActive ? C.paper : C.inkSoft }}>
